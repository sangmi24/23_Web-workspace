...
<body>
    ...
    <%
       ...
       String interest = (loginUser.getInterest() == null ) ? "" : loginUser.getInterest();  //"운동,영화,등산"
          ...
          <table> <!--border="1"-->
           ...
           <script>
               $(function() {
                 ...
                 // 관심분야 checkbox 에 동적으로 체크 될 수 있게끔 처리
                 
                 var interest = "<%= interest %>"; // "" / "운동, 등산, 게임"
                 
                 //var interestArr = "<%= interest %>".split(", ");

                 // 순차적으로 checkbox들에 접근 후 접근한 input 요소의 value 값이
        ...
        <div class="modal-body" align="center"> 
          ...
          <script>
            function validatePwd() {
              ...
              if($("input[name=updatePwd]").val() != $("input[name=checkPwd]").val()){ //일치하지 않는다면
